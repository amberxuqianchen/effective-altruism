...
outputpath <- '/home/local/PSYCH-ADS/xuqian_chen/Github/effective-altruism/3_output/HLM'
...
ggsave(file.path(outputpath, "OUS_pos_IB_MoralAgency.png"), plot, width = 6, height = 4)

plot <- plot_model(neg_IB_int,type = "pred", terms = c("moral","OUS_IB[minmax]","agency"))
ggsave(file.path(outputpath, "OUS_neg_IB_MoralAgency.png"), plot, width = 6, height = 4)

plot <- plot_model(pos_IH_int,type = "pred", terms = c("moral","OUS_IH[minmax]","agency"))
ggsave(file.path(outputpath, "OUS_pos_IH_MoralAgency.png"), plot, width = 6, height = 4)

plot <- plot_model(neg_IH_int,type = "pred", terms = c("moral","OUS_IH[minmax]","agency"))
ggsave(file.path(outputpath, "OUS_neg_IH_MoralAgency.png"), plot, width = 6, height = 4)
